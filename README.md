...
data1 <-read.csv("//cabinet.usask.ca/work$/rar727/My Documents/GitHub/Water-quality/data for thesis/clean data/Lake_1.csv", header = T)
...
## Import "Final_clean_data_set_1_TP" (\\cabinet.usask.ca\work$\rar727\My Documents\GitHub\Water-quality\data for thesis\clean data\clean lat_long data\FINAL DATA DMS TO DD)
Final_clean_data_set_1_TP <-read.csv("//cabinet.usask.ca/work$/rar727/My Documents/GitHub/Water-quality/data for thesis/clean data/clean lat_long data/FINAL DATA DMS TO DD/Final_clean_data_set_1_TP.csv", header = T)
...
install.packages("rio")
library("rio")
export(Final_marged_HPI_HD, "Final_marged_HPI_HD.csv")
...
Final_clean_data_set_2_SD <-read.csv("//cabinet.usask.ca/work$/rar727/My Documents/GitHub/Water-quality/data for thesis/clean data/clean lat_long data/FINAL DATA DMS TO DD/Final_clean_data_set_2_SD.csv", header = T)

## Import "Final_clean_data_set_2_SD" (\\cabinet.usask.ca\work$\rar727\My Documents\GitHub\Water-quality\data for thesis\clean data\clean lat_long data\FINAL DATA DMS TO DD)
...
##Add "Lake_ID" to "Final_wq_data" then import again
